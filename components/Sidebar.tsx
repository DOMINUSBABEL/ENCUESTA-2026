...
import { LayoutDashboard, BarChart3, Users, ThumbsDown, FileText, Menu, X } from 'lucide-react';
      ...
      >
        <div className="flex items-center justify-between h-16 px-6 bg-slate-950">
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-yellow-400 to-green-500 flex items-center justify-center text-slate-900 font-bold">
              A
            </div>
